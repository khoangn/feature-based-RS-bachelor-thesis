...
<div class="w3-container whole-page">
	...
	<div style="padding: 0 16px 0 16px">
		...
		<table class="w3-table w3-white w3-bordered w3-centered w3-card" >
			...
			<c:forEach items="${shoppingBasket}" var="basket">
			<tr>
				...
				<td style="vertical-align: middle">
					<form class="tooltip" action="RemoveFromBasketInBasketServlet" method="post">
						<input name="item-id" type="hidden" value="${basket.id}">
						<button id="remove-cart-${basket.id}" class="w3-button w3-ripple w3-circle user-icon delete-rating-up" type="submit">
					...
					<script>
						$('button[id^="remove-cart-${basket.id}"]').click(function(){
							localStorage.removeItem('${auid}-cart-${basket.id}');
						})					
					</script>
				</td>
			</tr>								
