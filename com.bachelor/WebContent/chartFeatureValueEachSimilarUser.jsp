...
<body>
	<div id="chart4" style="height:450px; width:950px; margin: 0; position:absolute; left:8px; padding: 0 24px 0 0;"></div>
	<script type="text/javascript" src="js/chartFeatureValueEachSimilarUser.js"></script>
</body>