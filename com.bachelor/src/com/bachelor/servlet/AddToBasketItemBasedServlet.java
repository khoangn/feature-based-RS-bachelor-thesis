...
@WebServlet("/AddToBasketItemBasedServlet")
public class AddToBasketItemBasedServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public AddToBasketItemBasedServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("INSERT INTO shopping_basket_item_based (active_user_id, item_id) VALUES (?, ?)");
