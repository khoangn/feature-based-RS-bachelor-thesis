...
@WebServlet("/RemoveFromBasketItemBasedInBasketServlet")
public class RemoveFromBasketItemBasedInBasketServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public RemoveFromBasketItemBasedInBasketServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.sendRedirect(getServletContext().getContextPath()+"/shopping_basket_item_based");
