...
@WebServlet("/DeleteRecommendedItemServlet")
public class DeleteRecommendedItemServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public DeleteRecommendedItemServlet() {
        super();
    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("DELETE FROM recommended_items WHERE active_user_id = ? AND item_id = ?");
